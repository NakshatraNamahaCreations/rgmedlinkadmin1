                    ...
                    return (
                      <tr key={r.id}
                       onClick={() => navigate(`/prescriptions/${r.id}`)}
                        style={{ borderBottom: `1px solid ${S.border}`, transition: "background .1s", background: isExpired(r.expiry) ? "#FFF8F8" : isExpiring(r.expiry) ? "#FFFDF0" : "transparent",  cursor: "pointer", }}
                      ...
                      >
                        ...
                        <td style={{ padding: "12px 14px" }}>
                          <span style={{ fontWeight: 600, color: S.ink }}>
                          {r.pName}
                        </span>
      ...
      {[...Array(Math.min(totalPages, 10))].map((_, i) => {
        ...
        return (
          <button
            ...
            style={pageBtn(currentPage === pageNum)}
          >
            {pageNum}
          </button>
        );
